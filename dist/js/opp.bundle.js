...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/js/opp.js");
/******/ })
/************************************************************************/
/******/ ({
...
var investmentDirectors = ["Andy Round", "Guy Weaver", "Mark Lyons"];
var iCReviewMembers = ["David Foreman", "Mike Fletcher", "Peadar Oreilly", "Rob Memmott"];
var legalDDProviders = ["Gateley", "Hilldicks", "Irwin Mitchell"];
var commercialDDProviders = ["PMSI", "None", "Other"];
var EisExperts = ["Phillip Hare", "Fairhurst"];
var targetCustomers = ["B2B", "B2C", "B2B2C"];
var investmentTeam = ["Andy Round", "Ben Hatton", "David Foreman", "Guy Weaver", "Jamie Newall", "Louise Chapman", "Mark Lyons", "Myrto Lalacos", "Pete Carway", "Sim Landa"];
var venturePartners = ["David Allanson", "Mark Austin", "Martin Bates", "Jonathan Bell", "Joanna Bond", "Christopher Carter", "Darren Carter", "Stephen Caunce", "Paul Chambers", "Paul Dewinter", "Sunil Dhall", "Mark Dickinson", "James Ellis", "Mahmoud Faghini", "Michael Fletcher", "David Foreman", "Colin Garnett", "Simon Gold", "Andrew Huntley Jacobs", "Paul Jefferson", "Paul Kenyon", "Richard Logan", "Simon Lord", "Kim Lucas", "Nikhil Mankodi", "Thomas Meikle", "Robert Memmott", "David Moore", "Iain Morgan", "Richard Nevinson", "Carolyn Nevinson", "Sean O'Driscoll", "Peadar O'Reilly", "Simon Radford", "Ashley Ramrachia", "Stephen Sealey", "Richard Sehayek", "Clifford Siegel", "Stephen Stuart", "Thomas Wood"];
var leadSource = ["Advisor Community", "HNW Investors / Venture Partner", "Inbound/Website Applications", "Industry Events", "Key Hubs / Accelerators", "Linkedin Cold Approach", "Other VC / PE Intro", "Personal Network (inc. Linkedin)", "Portfolio Businesses"];
var ICDecision = ['Approved', 'Monitor', 'Rejected'];
var funds = ["EIS 2019", "EIS 2020", "Evergreen Drawdown 1", "Evergreen Drawdown 2"];
var sideCarFunds = ["Tim Bulmer", "Simon Gold"]; //TODO need to update these and VP array

var sectors = ["Advertising, Marketing and Publishing", "Aerospace, Defence and Space Tech", "AI and Big Data", "Bio Tech and Pharmaceuticals", "Digital Media and Content", "E-commerce", "Education Technology", "Electronics and Hardware", "Energy, Environment and Clean Tech", "Fashion and Design", "Fast Moving Consumable Goods", "Film, Theatre and Entertainment", "Financial and Professional Services", "Financial Technology", "Gaming", "Healthcare and Digital Health", "HR and Recruitment", "Leisure, Hospitality and Tourism", "Manufacturing and Engineering", "Mining and Materials", "Mobile and Telecoms", "Property and Construction", "Security and Cyber Security", "Social Enterprise", "Software as a Service", "Transport and Logistics"];
...
var inputList = [{
  ...
  1: {
    one_OppName: "STRING",
    one_PvLead: investmentTeam,
    one_IntroDate: "DATEONLY",
    one_Introducer: leadSource,
    one_Referrer: venturePartners,
    one_InvestmentAmount: "INTEGER",
    one_PreMoney: "INTEGER",
    one_TotalInvestment: "INTEGER",
    one_EquityPercentage: "FLOAT",
    one_Location: "STRING",
    one_Sector: sectors,
    one_InvestmentStage: investmentStage,
    one_InvestmentToDate: "INTEGER",
    one_Activity: "STRING",
    one_TargetCustomers: targetCustomers
  }
}, {
  2: {
    two_NdaSigned: "RADIO",
    two_TeamMembers: "MULTISELECT"
  }
}, {
  3: {
    three_CompanyDescription: "TEXTAREA",
    three_PvSplit: "INTEGER",
    three_VpSplit: "INTEGER",
    three_FundAllocation: "INTEGER",
    three_proposalSentDateTeam: "DATEONLY",
    three_ProposalSentDateIc: "DATEONLY",
    three_IcMeetingDate: "DATEONLY",
    three_IcApproved: "RADIO"
  }
}, {
  4: {
    ...
    four_PriorReturn: "RADIO",
    four_expectedCompletionDate: "DATEONLY",
    four_OfferTeamReviewer: investmentDirectors,
    four_OfferReviewedDate: "DATEONLY",
    four_OfferIcReviewer: iCReviewMembers,
    four_OfferIcApprovedDate: "DATEONLY",
    four_OfferSentDate: "DATEONLY"
  }
}, {
  5: {
    divider1: "Financial DD:",
    five_financialExternalProviderEngaged: "RADIO",
    five_financialSummary: "TEXTAREA",
    divider2: "Legal DD:",
    five_lawyersUsed: legalDDProviders,
    five_LegalFee: "INTEGER",
    five_CompanyLawyer: "STRING",
    five_LegalSummary: "TEXTAREA",
    five_ArticlesSummary: "TEXTAREA",
    five_IaSummary: "TEXTAREA",
    five_CovenantSummary: "TEXTAREA",
    divider3: "Commercial DD:",
    five_CddUsed: commercialDDProviders,
    five_CddFee: "INTEGER",
    five_CddSummary: "TEXTAREA",
    divider4: "Management DD:",
    five_MddExternalProviderEngaged: "RADIO",
    five_MddProvider: "STRING",
    five_MddFee: "INTEGER",
    five_MgtReferencesDone: "RADIO",
    five_MddSummary: "TEXTAREA",
    divider5: "KYC Checks:",
    five_KycConfirmedSignificantHolders: "RADIO",
    five_KycDateCompleted: "DATEONLY",
    divider6: "EIS Compliance:",
    five_EisReviewed: "RADIO",
    five_EisAdvisor: EisExperts,
    five_EisSubmissionDate: "DATEONLY",
    divider7: "DD Review:",
    five_DealSummaryDone: "RADIO",
    five_DdReviewed: "RADIO",
    five_DdReviewer: investmentDirectors,
    five_DdReviewDate: "DATEONLY"
  }
}, {
  6: {
    six_DateFinalIc: "DATEONLY",
    six_InvestmentAmount: "INTEGER",
    six_Premoney: "INTEGER",
    six_TotalRound: "INTEGER",
    six_EquityFinal: "FLOAT",
    six_PriorReturn: "RADIO",
    six_CommitteeDecision: ICDecision,
    six_DecisionSupport: "MULTILINE"
  }
}, {
  7: {
    seven_EisAssuranceReceived: "RADIO",
    seven_DateEisReceived: "DATEONLY",
    seven_PortfolioIntroduced: "RADIO",
    seven_PrDone: "RADIO",
    seven_ReviewedManagementAccs: "RADIO",
    seven_FinalLegalBible: "RADIO",
    seven_AgreedBoard: "RADIO",
    seven_SummarySent: "RADIO"
  }
}, {
  8: {
    divider1: "EIS Admin:",
    eight_CompletionDate: "DATEONLY",
    eight_EisOneSentDate: "DATEONLY",
    eight_EisThreeReceivedDate: "DATEONLY",
    eight_EisFiveSentDate: "DATEONLY",
    eight_EisFiveReceivedDate: "DATEONLY",
    eight_UploadedEisToPortal: "RADIO",
    divider2: "Deal Allocation Summary:",
    divider3: "SideCar Allocations:",
    eight_SidecarInvestorOne: sideCarFunds,
    eight_SidecarInvestorOneAmount: "INTEGER",
    ...
    eight_SidecarInvestorTwo: sideCarFunds,
    eight_SidecarInvestorTwoAmount: "INTEGER",
    ...
    divider4: "Venture Partner Allocations:",
    eight_VpInvestorOne: venturePartners,
    eight_VpInvestorOneAmount: "INTEGER",
    ...
    eight_VpInvestorTwo: venturePartners,
    eight_VpInvestorTwoAmount: "INTEGER",
    ...
    eight_VpInvestorThree: venturePartners,
    eight_VpInvestorThreeAmount: "INTEGER",
    ...
    eight_VpInvestorFour: venturePartners,
    eight_VpInvestorFourAmount: "INTEGER",
...
var fieldNameMapping = {
  ...
  five_financialExternalProviderEngaged: "Financial DD completed Externally?",
  five_financialSummary: "Financial DD Summary",
  five_lawyersUsed: "PV - Lawyers Used",
  five_LegalFee: "Legal Fee",
  five_CompanyLawyer: "Legal Provider Used On Otherside",
  five_LegalSummary: "LDD Summary",
  five_ArticlesSummary: "AoA Summary",
  five_IaSummary: "Investment Agreement Summary",
  five_CovenantSummary: "Investor Covenant Summary",
  five_CddUsed: "CDD Provider",
  five_CddFee: "CDD Fee",
  five_CddSummary: "CDD Summary",
  five_MddExternalProviderEngaged: "MDD External Provider Engaged?",
  five_MddProvider: "MDD Provider",
  five_MddFee: "MDD Fee",
  five_MgtReferencesDone: "Have We Referenced Management?",
  five_MddSummary: "MDD Summary",
  five_KycConfirmedSignificantHolders: "KYC Confirmed on Shareholders with 10%+ Holding?",
  five_KycDateCompleted: "Date KYC Completed",
  five_EisReviewed: "Has The EIS AA been Completed and Reviewed?",
  five_EisAdvisor: "Reviewed By",
  five_EisSubmissionDate: "Date EIS AA Submitted",
  five_DealSummaryDone: "Deal 2 Page Summary Ready?",
  five_DdReviewed: "DD and Legals Reviewed For Completeness?",
  five_DdReviewer: "DD Internal Reviewer",
  five_DdReviewDate: "Date DD Review Conducted",
  six_DateFinalIc: "Date of Final IC",
  six_InvestmentAmount: "PV Investment",
  six_Premoney: "Premoney Valuation",
  six_TotalRound: "Total Round",
  six_EquityFinal: "PV Equity %",
  six_PriorReturn: "Do We Have a Prior Return?",
  six_CommitteeDecision: "Investment Committee Decision",
  six_DecisionSupport: "IC Rationale",
  seven_EisAssuranceReceived: "Have We Received EIS AA?",
  seven_DateEisReceived: "Date AA Received",
  seven_PortfolioIntroduced: "Has We Introduced the Portfolio Team?",
  seven_PrDone: "Have We Arranged PR With Marketing?",
  seven_ReviewedManagementAccs: "Have We Reviewed The Latest Management Accounts?",
  seven_FinalLegalBible: "Have We Received and Saved Final Legal Bible?",
  seven_AgreedBoard: "Have We Agreed Who Will Take The Observer and ID Board Seat?",
  seven_SummarySent: "Have We Sent The Completion Memo to Marketing?",
  eight_CompletionDate: "Date Deal Completed",
  eight_EisOneSentDate: "Date EIS 1 Sent",
  eight_EisThreeReceivedDate: "Date EIS 3 Received",
  eight_EisFiveSentDate: "Date EIS 5 Sent",
  eight_EisFiveReceivedDate: "Date EIS 5 Received",
  ...
  eight_VpInvestorOne: "VP1 Name",
  eight_VpInvestorOneAmount: "VP1 Amount Invested",
  eight_VpInvestorOneTransactionDate: "VP1 Transaction Date",
  eight_VpInvestorOneCompletionDate: "VP1 Completion Date",
  eight_VpInvestorOneEquity: "VP1 Equity %",
  eight_VpInvestorOneShares: "VP1 Shares bought",
  eight_VpInvestorTwo: "VP2 Name",
  eight_VpInvestorTwoAmount: "VP2 Amount Invested",
  eight_VpInvestorTwoTransactionDate: "VP2 Transaction Date",
  eight_VpInvestorTwoCompletionDate: "VP2 Completion Date",
  eight_VpInvestorTwoEquity: "VP2 Equity %",
  eight_VpInvestorTwoShares: "VP2 Shares bought",
  eight_VpInvestorThree: "VP3 Name",
  eight_VpInvestorThreeAmount: "VP3 Amount Invested",
  eight_VpInvestorThreeTransactionDate: "VP3 Transaction Date",
  eight_VpInvestorThreeCompletionDate: "VP3 Completion Date",
  eight_VpInvestorThreeEquity: "VP3 Equity %",
  eight_VpInvestorThreeShares: "VP3 Shares bought",
  eight_VpInvestorFour: "VP4 Name",
  eight_VpInvestorFourAmount: "VP4 Amount Invested",
  eight_VpInvestorFourTransactionDate: "VP4 Transaction Date",
  eight_VpInvestorFourCompletionDate: "VP4 Completion Date",
  eight_VpInvestorFourEquity: "VP4 Equity %",
  eight_VpInvestorFourShares: "VP4 Shares bought"
...
function generateHtmlInputs(inputList) {
  ...
  inputList.forEach(function (stage, index) {
    var currentStage = "stage-".concat(Object.keys(inputList[index])[0], "-fields");
    var stageFieldContainer = document.createElement('div');
    stageFieldContainer.classList.add("field-set");
    stageFieldContainer.id = currentStage;
    var wrapperId = "stage-".concat(Object.keys(inputList[index])[0], "-first-divider");
    var htmlToInject = "<div class=\"field-divider-wrapper\" id=\"".concat(wrapperId, "\">");

    for (field in inputList[index][Object.keys(inputList[index])]) {
      if (/divider\d/.test(field)) {
        var dividerId = "".concat(inputList[index][Object.keys(inputList[index])][field], "-divider");
        ...
        var selectArr = inputList[index][Object.keys(inputList[index])][field];
        var optionsHtml = void 0;
        selectArr.forEach(function (value) {
          var optionValue = "<option value=\"".concat(value, "\">").concat(value, "</option>");
...
function insertSelect(optionsArr, FieldName) {
  ...
  optionsArr.forEach(function (option) {
    optionsHtml += "<option value=\"option\">".concat(option, "</option>");
  });
  var htmlToInsert = "\n    <select class=\"form-control\" id=\"".concat(field, "\">\n          <option value=\"\"></option>\n          ").concat(optionsHtml, "\n    </select>\n    ");
  return htmlToInsert;
}
...
function insertDate(FieldName) {
  var html = "\n                    <input class=\"datepicker-ui validate form-control\" id=\"".concat(FieldName, "\"/>\n\n                    ");
  return html;
}

function insertIntegerInput(FieldName) {
  var html = "\n                         \n         <input  id=\"".concat(FieldName, "\" type=\"number\" class=\"validate form-control\">                        \n                     \n    ");
  return html;
}
...
function generateStageEightAllocationTable() {
  var entryPoint = document.getElementById("Deal Allocation Summary:-divider");
  var htmlToInsert = "<table id=\"eight-table\">\n  <tr class=\"eight-table-row\">\n    <th class=\"td-padding\" id=\"eight-table-header\">Fund Allocation Summary</th>\n    <th class=\"td-padding\">Tranche 1</th>\n    <th class=\"td-padding\">Tranche 2</th>\n    <th class=\"td-padding\">Tranche 3</th>\n    \n  </tr>\n  <tr class=\"eight-table-row\">\n    <td class=\"td-padding\">EIS Fund</td>\n    <td class=\"td-padding\">".concat(insertSelect(funds, "eight_TrancheOneFund"), "</td>\n    <td class=\"td-padding\">").concat(insertSelect(funds, "eight_TrancheTwoFund"), "</td>\n    <td class=\"td-padding\">").concat(insertSelect(funds, "eight_TrancheThreeFund"), "</td>\n    \n  </tr>\n  <tr class=\"eight-table-row\">\n    <td class=\"td-padding\">Amount</td>\n    <td class=\"td-padding\">").concat(insertIntegerInput("eight_TrancheOneAmount"), "</td>\n    <td class=\"td-padding\">").concat(insertIntegerInput("eight_TrancheTwoAmount"), "</td>\n    <td class=\"td-padding\">").concat(insertIntegerInput("eight_TrancheThreeAmount"), "</td>\n  \n  </tr>\n  <tr class=\"eight-table-row\">\n    <td class=\"td-padding\">Transaction Date</td>\n    <td class=\"td-padding\">").concat(insertDate("eight_TrancheOneTransactionDate"), "</td>\n    <td class=\"td-padding\">").concat(insertDate("eight_TrancheTwoTransactionDate"), "</td>\n    <td class=\"td-padding\">").concat(insertDate("eight_TrancheThreeTransactionDate"), "</td>\n   \n  </tr>\n  <tr class=\"eight-table-row\">\n    <td class=\"td-padding\">Completion Date</td>\n    <td class=\"td-padding\">").concat(insertDate("eight_TrancheOneCompletionDate"), "</td>\n    <td class=\"td-padding\">").concat(insertDate("eight_TrancheTwoCompletionDate"), "</td>\n    <td class=\"td-padding\">").concat(insertDate("eight_TrancheThreeCompletionDate"), "</td>   \n  </tr>\n  <tr class=\"eight-table-row\">\n    <td class=\"td-padding\">Number of Shares</td>\n    <td class=\"td-padding\">").concat(insertIntegerInput("eight_TrancheOneShares"), "</td>\n    <td class=\"td-padding\">").concat(insertIntegerInput("eight_TrancheTwoShares"), "</td>\n    <td class=\"td-padding\">").concat(insertIntegerInput("eight_TrancheThreeShares"), "</td>   \n  </tr>\n  <tr class=\"eight-table-row\">\n    <td class=\"td-padding\">Equity (%)</td>\n    <td class=\"td-padding\">").concat(insertIntegerInput("eight_TrancheOneEquity"), "</td>\n    <td class=\"td-padding\">").concat(insertIntegerInput("eight_TrancheTwoEquity"), "</td>\n    <td class=\"td-padding\">").concat(insertIntegerInput("eight_TrancheThreeEquity"), "</td>   \n  </tr>\n</table>");
...
var bootstrap = __webpack_require__(/*! bootstrap/dist/js/bootstrap.bundle.min */ "./node_modules/bootstrap/dist/js/bootstrap.bundle.min.js");

var UIController = __webpack_require__(/*! ./uicontroller.js */ "./src/js/uicontroller.js");

var inputController = __webpack_require__(/*! ./inputController */ "./src/js/inputController.js");



var inputList = inputController.inputList;
...
inputController.generateStageEightAllocationTable(); //TODO need to take note of the stage before init here
...
/******/ });
//# sourceMappingURL=opp.bundle.js.map